import os,sys
import numpy as np
from model.pair_features import load_pairs_as_dict, generate_data, save_data_to_hdf5, load_data_from_hdf5
from model.func_genetic_model import train_estimator
...
if __name__=='__main__':
    ...
    if args.generate_from_pairs:
        annotations = []
        for i in ann_files:
            annotations.append(save_data_to_hdf5(i))
